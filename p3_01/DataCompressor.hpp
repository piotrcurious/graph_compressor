...
#define POLY_DEGREE 7               // The degree of the polynomials used for storing compressed data.
#define SUB_FIT_POLY_DEGREE 4       // Degree for the supplementary fitter, used to improve boundary transitions.
#define BOUNDARY_MARGIN3 10          // Margin for the sub-fitter, (pre-fit) helps in creating a smoother fit.
#define BOUNDARY_DELTA3 10          // Time window of the margin for the sub-fitter.
#define BOUNDARY_MARGIN 0           // Margin for the main fitter (future - leading edge).
